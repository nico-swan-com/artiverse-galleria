...
const ArtworkDetail = ({ id }: ArtworkDetailProps) => {
  ...
  const currentUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/artworks/${id}`
  ...
  const toggleFavorite = () => {
    ...
    toast(isFavorite ? 'Removed from wishlist' : 'Added to wishlist', {
      description: `${artwork.title} has been ${
      ...
      <div className='mx-auto max-w-7xl'>
        ...
        <div className='grid grid-cols-1 gap-12 lg:grid-cols-2'>
          ...
          <div className='space-y-6'>
            ...
            <div className='space-y-4 border-b border-t py-4'>
              <div className='grid grid-cols-2 gap-4'>
                <div>
            ...
            <div className='border-t pt-6'>
              ...
              <div className='flex items-center space-x-4'>
                <QRCode url={currentUrl} size={150} title={artwork.title} />
                <div>
